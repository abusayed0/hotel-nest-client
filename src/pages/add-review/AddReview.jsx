        ...
        <div className="bg-[lightgray] w-full md:w-4/5 lg:w-1/2 md:mx-auto p-2 md:p-16">
            ...
            <form onSubmit={handleAddReview} className="mt-9 flex flex-col gap-7">
                <div className="flex flex-col gap-4">
                    ...
                    <input readOnly value={displayName} className="p-4 rounded-xl outline outline-1 outline-[#E8E8E8] focus-within:outline-[#643843]" type="text" name="name" id="name" placeholder="Your Name" required />
                </div>
                <div className="flex flex-col gap-4">
